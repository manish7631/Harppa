      ...
      <div className="About_Main">
        ...
        >
          <div className="para">
            ...
            a major multidisciplinary research project which aims to re-vision
            the history of Asia in one of its most significant periods. The
            project is based at the British Museum, British Library and the
            School of Oriental and African Studies, and funded by an ERC-Synergy
            grant for 2014-2020. The project focusses on the period of the
            Guptas (circa 320 to 550), a pivotal moment in the history of Asia,
            marked by an astonishing florescence in every field of endeavour.
            The Gupta kingdom and its networks had an enduring impact on India
            and a profound reach across Central and Southeast Asia in a host of
            cultural, religious and socio-political spheres. The project
            comprises an interdisciplinary team spanning linguistics, history,
            religious studies, geography, archaeology, numismatics, Indology,
            Sinology and GIS/IS technologies. This team will generate synergies
            to delineate and assess the significance of the Gupta Age and its
