...
import { BNGLImageGetFunction } from "../../../../redux/Application/action";
...
export default function BnglTablePage({ loading, countryList, query1 }) {
  ...
  const { isLoading, BNGLImageData } = useSelector(
  ...
  console.log("data", BNGLImageData);
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - BNGLImageData.length) : 0;
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Box className="Bngl_TableList_LargeDevice">
            ...
            <TableContainer>
              ...
              >
                ...
                <TableBody>
                  ...
                  {stableSort(BNGLImageData, getComparator(order, orderBy))
      ...
      <Box className="Bngl_CardList_MobileDevice">
        {query ? (
          <>
            {BNGLImageData.slice(
              pageSearch * perpage,
              ...
              let newArr = str1.split("', '");
              return (
                <Card className="Bngl_Card_Mobile">
                  <CardActionArea>
                    <CardContent
                      sx={{
                        display: "flex",
                    ...
                    >
                      <h3 className="Bngl_Mobile_Card_Left">Seqid</h3>

                      <h4 className="Bngl_Mobile_Card_Right">
                        <span
                          style={{
                            width: "100px",
                            overflow: "hidden",
                    ...
                    >
                      <h3 className="Bngl_Mobile_Card_Left">Seq_In_Nums</h3>
                    ...
                    >
                      <h3 className="Bngl_Mobile_Card_Left">Site</h3>
                    ...
                    >
                      <h3 className="Bngl_Mobile_Card_Left">Links</h3>
                    ...
                    >
                      <h3 className="Bngl_Mobile_Card_Left">Actions</h3>
