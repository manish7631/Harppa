...
export default function EranTablePage({ loading, countryList, query1 }) {
  ...
  const { isLoading, EranImageSearchData, EranImageData } = useSelector(
  ...
  const emptyRows =
    page > 0
      ? Math.max(0, (1 + page) * rowsPerPage - EranImageSearchData.length)
      : 0;
        ...
        <Paper sx={{ width: "100%", mb: 2 }}>
            ...
            >
              ...
              >
                <EnhancedTableHead
                  ...
                  rowCount={EranImageSearchData.length}
                />
                <TableBody>
            ...
            <TableContainer>
              ...
              >
                ...
                <TableBody>
                  ...
                  {stableSort(EranImageData, getComparator(order, orderBy))
          ...
          {query ? (
            ...
            <TablePagination
              ...
              component="div"
              count={EranImageSearchData.length}
              rowsPerPage={perpage}
              page={pageSearch}
